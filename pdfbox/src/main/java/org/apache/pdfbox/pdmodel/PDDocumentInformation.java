...
public class PDDocumentInformation implements COSObjectable
{
    ...
    private final PDDocumentManuscriptInformation manuscriptInfo;
    ...
    public PDDocumentInformation()
    {
        ...
        manuscriptInfo = new PDDocumentManuscriptInformation();
    }
    ...
    {
        info = dic;
        manuscriptInfo = new PDDocumentManuscriptInformation(dic);
    }
    ...
    public PDDocumentManuscriptInformation getManuscriptInfo() {
